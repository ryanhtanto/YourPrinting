                ...
                <div class="row">
                        <div class="col-lg-4 col-sm-4">
                                <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('jenis_layanan') is-invalid @enderror" id="jenis_layanan" name="jenis_layanan">
                        ...
                        <div class="col-lg-4 col-sm-4">
                                <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('bahan') is-invalid @enderror" id="bahan" name="bahan">
